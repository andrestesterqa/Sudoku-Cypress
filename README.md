# sudoku [![CI](https://github.com/andrestesterqa/Sudoku-Cypress/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/andrestesterqa/Sudoku-Cypress/actions/workflows/ci.yml)
